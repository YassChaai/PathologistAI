...
TRAIN_MAPPING = Path("../Data/dataset_lists/train_mapping.csv")
BATCH_SIZE = 6
...
ANN_DIR = CAMELYON_ROOT / "annotations"

# Scripts existants
DOWNLOAD_SCRIPT = "download_train_from_aws.py"
PROCESS_BATCH_SCRIPT = "process_batch_train.py"
...
def main():
    ...
    for i in range(n_batches):
        ...
        # Vérifier quels patients du batch ont déjà été traités
        patients_a_traiter = []
        ...
        batch_mapping = Path(f"../Data/dataset_lists/batches_train/batch_mapping_batch_{i + 1:03d}.csv")
